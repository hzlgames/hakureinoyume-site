...
本项目是 `hakureinoyume.com` 的个人网站，使用 Next.js App Router 和 TypeScript。当前主要功能包括首页仪表盘、互动灵梦小宠物、Better Auth 多用户账号系统、后台账号与背景管理、ZJU 工具箱、天气与节日日历 API，以及通过 Caddy 和 systemd 运行的生产部署。
